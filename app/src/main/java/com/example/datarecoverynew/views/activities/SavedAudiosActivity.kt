...
import com.example.datarecoverynew.databinding.ActivitySavedAudiosBinding
...
class SavedAudiosActivity : BaseActivity() {
    lateinit var binding: ActivitySavedAudiosBinding
    ...
    var groupAudios: ArrayList<GroupFilesModel> = ArrayList<GroupFilesModel>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySavedAudiosBinding.inflate(layoutInflater)
            ...
            if (recoverAudios.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (!isSucces) {
                        isDeleted = false
                        Toast.makeText(
                            this@SavedAudiosActivity, getString(R.string.try_again_later),
                            Toast.LENGTH_SHORT
                        ).show()
                        recoverAudios.clear()
                        break
                ...
                if (isDeleted) {
                    recoverAudios.clear()
                    MediaScanner(this@SavedAudiosActivity)
                    Toast.makeText(
                        this@SavedAudiosActivity,
                    ...
                    /*  val adapter =
                          DocumentAdapter(this@SavedAudiosActivity, audioList, object : DataListener {
                              override fun onRecieve(any: Any) {

                                  var file = any as FilesModel
  ...
  //                                playAudio(file.file)
        ...
        binding.viewMoreBtn.setOnClickListener {
            watchADDialog(this@SavedAudiosActivity, object : DataListener {
                override fun onRecieve(any: Any) {
                    val watchAd = any as Boolean
                    if (watchAd) {

                        binding.adloadingscreen.isVisible = true
                        loadRewardedAd(this@SavedAudiosActivity)
...
//                        }
                ...
                override fun onPremium(any: Any) {
                    ...
                    if (any as Boolean) {
                        val intent = Intent(this@SavedAudiosActivity, PremiumActivity::class.java)
        ...
        RewardedAd.load(
            ...
            object : RewardedAdLoadCallback() {
                ...
                override fun onAdLoaded(ad: RewardedAd) {
                    ...
                    binding.adloadingscreen.isVisible = false
                    showRewardedAd(this@SavedAudiosActivity)
                }
            }
        )
    }
    ...
    private fun observer() {
        ...
        mainViewModel.liveDataSavedIsDataLoaded.observe(this) {
            if (it) {
                ...
                audioList.clear()
                audioList.addAll(mainViewModel.audiosSavedList)
                if (audioList.isEmpty()) {
                    binding.noTV.visibility = View.VISIBLE
                    binding.recoverBtn.visibility = View.GONE
                } else {
                ...
                tempList.forEachIndexed { index, model ->
                    ...
                    if (DeviceUtils.isDeviceRooted().not()) {
                        ...
                        val adId = AdDatabaseUtil.getAdmobNativeAdId(this@SavedAudiosActivity)
        ...
        binding.recylerView.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
                ...
                if (!recyclerView.canScrollVertically(1)) {
                    if (audioList.size > 50 && !AppPreferences.getInstance(this@SavedAudiosActivity).isAppPurchased && !adapter.isWatchAd) {

...
import com.example.datarecoverynew.databinding.FragmentDuplicateScanningBinding
...
class DuplicateScanningFragment : BottomSheetDialogFragment() {

    private val binding by lazy { FragmentDuplicateScanningBinding.inflate(layoutInflater) }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (isNativeHomeEnabled()) {
            showNativeAd(binding.frameNativeProgressDuplicate)
        } else {
            binding.frameNativeProgressDuplicate.visibility = View.GONE
        }

    }

    private fun isNativeHomeEnabled(): Boolean {
        return sharedPrefsHelper.getIsNativeDuplicateDialogEnabled()
    }
